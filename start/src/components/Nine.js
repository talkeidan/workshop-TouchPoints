...
const Nine = ({onPress}) => {
    ...
    return <View style={{flexGrow: 1}}>
            <RewardsComponent
                ...
                state={rewardState}>
            <ImageBackground style={styles.bgimage} source={require("../../assets/kid9.png")} resizeMode="contain">
                ...
                <Point unpressedStyle={styles.button9} pressedStyle={styles.button9pressed} setCounter={() => setCounter(counter - 1)} setRewardState={(rewardState) => setRewardState('reward')} count={counter}/>
            </ImageBackground>
            </RewardsComponent>
            </View>
}
