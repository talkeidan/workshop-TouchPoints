...
// 810
    ...
    if (reward == 'rest') {
        ...
        <View style={{alignSelf: "center", marginTop: "15%", height: "35%", borderColor: "grey", width: "40%",  borderRadius: normalize(20), borderWidth: 1}}/>
    ...
    if (isLeftComplete || isRightComplete) {
        return <View style={{height: "100%", width: "100%"}}>
        <View style={{alignSelf: "center", marginTop: "15%", borderColor: "grey", borderRadius: normalize(20), borderWidth: 1, height: "35%", width: "40%"}}>
