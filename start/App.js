...
import { I18nManager, StyleSheet, Button} from 'react-native';
...
YellowBox.ignoreWarnings([
  'Animated: `useNativeDriver` was not specified.', 'Non-serializable values were found in the navigation state.'
]);
 ...
 function MyStack() {
   return (
    ...
    headerTitleStyle:{borderColor: 'black', fontFamily: 'Arial Rounded MT Bold', fontWeight: 'bold' },}}>
      ...
      headerRight: () => <Button onPress={null}
      title="Info"
      color="#fff"/>,
      }}/>
